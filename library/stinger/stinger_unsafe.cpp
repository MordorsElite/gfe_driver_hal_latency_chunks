...
template vector<pair<uint64_t, double>> Stinger::to_external_ids<double>(const double* __restrict internal_ids, size_t internal_ids_sz);
template vector<pair<uint64_t, int64_t>> Stinger::to_external_ids<int64_t>(const vector<int64_t>& internal_ids);
template vector<pair<uint64_t, int64_t>> Stinger::to_external_ids<int64_t>(const int64_t* __restrict internal_ids, size_t internal_ids_sz);
template vector<pair<uint64_t, uint64_t>> Stinger::to_external_ids<uint64_t>(const vector<uint64_t>& internal_ids);
template vector<pair<uint64_t, uint64_t>> Stinger::to_external_ids<uint64_t>(const uint64_t* __restrict internal_ids, size_t internal_ids_sz);
...
bool Stinger::remove_edge_v2(gfe::graph::WeightedEdge e, int thread_id)
{
    //
}
/******************************************************************************
