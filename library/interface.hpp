 ...
 */
    ...
    public:
         ...
         */
        virtual bool remove_edge(gfe::graph::Edge e, int thread_id) = 0;
        virtual bool remove_edge_v2(gfe::graph::WeightedEdge e, int thread_id) = 0;
        ...
        struct SingleUpdate {
            ...
            double m_weight;
            int64_t s_timestamp;
            // if < 0, this is an edge removal, otherwise it's an edge insertion with the given weight
        };
