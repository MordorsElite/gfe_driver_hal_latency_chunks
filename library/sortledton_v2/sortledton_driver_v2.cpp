...
//      tm.register_thread(thread_id);
    ...
    uint64_t SortledtonDriverV2::on_thread_destroy(int thread_id) {
...
//      return inserted;
    ...
    bool SortledtonDriverV2::add_edge_v2(gfe::graph::WeightedEdge e, int thread_id) {
      assert(!m_is_directed);
...
//      return inserted;
    ...
    bool SortledtonDriverV2::remove_edge(gfe::graph::Edge e, int thread_id) {
      throw sortledton::NotImplemented {};
//      assert(!m_is_directed);
...
//      return removed;
    ...
    bool SortledtonDriverV2::remove_edge_v2(gfe::graph::WeightedEdge e, int thread_id)
    {
        //
    }
