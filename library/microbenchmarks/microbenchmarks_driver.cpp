...
namespace gfe::library {
    ...
    uint64_t MicroBenchmarksDriver::on_thread_destroy(int thread_id) {}
    ...
    bool MicroBenchmarksDriver::add_edge_v2(gfe::graph::WeightedEdge e, int thread_id) {
      {
        vertex_mapping::const_accessor a;
        vertex_mapping::const_accessor b;
    ...
    bool MicroBenchmarksDriver::remove_edge(gfe::graph::Edge e, int thread_id) {
      throw exception();
    }
    bool MicroBenchmarksDriver::remove_edge_v2(gfe::graph::WeightedEdge e, int thread_id)
    {
