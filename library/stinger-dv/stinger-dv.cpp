...
bool StingerDV::add_edge_v2(gfe::graph::WeightedEdge e, int thread_id){
    add_vertex(e.source());
    add_vertex(e.destination());
    return add_edge(e);
}

bool StingerDV::remove_edge(graph::Edge e, int thread_id){
    int rc = 0;
    if(m_directed){ // directed graph
...
bool StingerDV::remove_edge_v2(gfe::graph::WeightedEdge e, int thread_id)
{
        //
}
/******************************************************************************
