...
WeightedEdge::WeightedEdge() : WeightedEdge(0,0,0,0){ }
WeightedEdge::WeightedEdge(uint64_t source, uint64_t destination, double weight, int64_t timestamp) : Edge{source, destination}, m_weight(weight),srcTimestamp(timestamp){
