...
public:
    // properties
    int out_of_order_workload{0};
    bool s{false};
    bool m_is_duplicate_support{false};
...
public:
    std::string m_path_graph_to_load;
    ...
    int is_out_of_order_workload() const{return out_of_order_workload;}
    bool is_duplicate_support() const{return m_is_duplicate_support;}
