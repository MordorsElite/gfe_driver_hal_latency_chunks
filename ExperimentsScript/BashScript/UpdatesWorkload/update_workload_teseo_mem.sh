...
./gfe_driver -G /local/user/gfe_datasets/graph500-24.properties -u --log /local/user/graph500-24-1.0.graphlog -l "${teseo}" -w 40 -d results.sqlite3 --aging_memfp  --aging_memfp_physical  --aging_release_memory false
