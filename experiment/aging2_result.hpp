...
public:
    ...
    struct MemoryFootprint { uint64_t m_tick; uint64_t m_memory_process; uint64_t m_memory_driver; bool m_is_cooloff; };
    ...
    void save(common::Database* db, bool is_database = true);
    void save(std::shared_ptr<common::Database> db, bool is_database = true);
};
